...
export const project = [
  ...
  },
  {
    ...
    knowledgeGained: [
      ...
      "Finance workflow process flows: Learned about the business of finance workflow process flows, which helps businesses streamline tedious and repetitive finance processes such as purchase requests to increase the productivity and efficiency of the teams involved.",
    ],
  },
  {
    code: "BAV",
